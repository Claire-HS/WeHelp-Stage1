    ...
    for person, message in messages.items():
        ...
        for mx in m:
            ...
            if(len(curline)>len(personline)):
                ...
                if(curline==line2 and personline==line1):
                    station = [current_station] + list(reversed(personline))
                elif(curline==line3 and personline==line1):
                    station = [current_station] + list(reversed(personline))
                else:
                    station = curline + personline
            else:
            ...
            # print("station=",station, "person_idx=", person_idx, "cur_index", cur_index)
